...
ALLOWED_HOSTS = ["assad-ecommerce-api-fcdd9d584d93.herokuapp.com/", ".herokuapp.com", "localhost", "127.0.0.1"]
...
CELERY_RESULT_BACKEND = 'redis://redis:6379/0'  # Redis as result backend
